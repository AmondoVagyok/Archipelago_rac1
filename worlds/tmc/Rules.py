...
class MinishCapRules():
    ...
    def __init__(self, world: "MinishCapWorld") -> None:
        ...
        self.connection_rules = {
            ...
            (TMCRegion.DUNGEON_DHC, TMCRegion.VAATI_FIGHT):
                self.logic_and([
                    ...
                    self.has(TMCItem.PROGRESSIVE_SWORD, 5),
                ]),
            ...
            (TMCRegion.WESTERN_WOODS, TMCRegion.CASTOR_WILDS):
                self.has_any([TMCItem.PEGASUS_BOOTS, TMCItem.ROCS_CAPE]),
            ...
            (TMCRegion.CRENEL_BASE, TMCRegion.CRENEL):
                self.logic_or([
                    self.has_any([TMCItem.GRIP_RING, TMCItem.BOMB_BAG]),
                ]),
            ...
            (TMCRegion.CLOUDS, TMCRegion.WIND_TRIBE):
                self.logic_and([
                    self.has(TMCItem.KINSTONE_GOLD_CLOUD, 5),
                    self.has_any([TMCItem.MOLE_MITTS, TMCItem.ROCS_CAPE]),
                ]),
            (TMCRegion.WIND_TRIBE, TMCRegion.DUNGEON_POW):
                self.logic_and([
                    self.has_any([TMCItem.ROCS_CAPE, TMCItem.PROGRESSIVE_BOOMERANG, TMCItem.PROGRESSIVE_BOW]),
                    self.split_rule(3),
                ]),
            ...
            (TMCRegion.CASTOR_WILDS, TMCRegion.WIND_RUINS):
                self.logic_and([
                    self.has(TMCItem.KINSTONE_GOLD_SWAMP, 3),
                    self.logic_or([
                        self.has(TMCItem.ROCS_CAPE),
                        self.has_all([TMCItem.FLIPPERS, TMCItem.PEGASUS_BOOTS]),
                        self.has_all([TMCItem.PROGRESSIVE_BOW, TMCItem.PEGASUS_BOOTS]),
                    ])
                ]),
            (TMCRegion.WIND_RUINS, TMCRegion.DUNGEON_FOW): None,
        ...
        self.location_rules = {
            ...
            TMCLocation.SOUTH_FIELD_TINGLE_NPC:
                self.logic_and([
                    self.can_pass_trees(),
                    self.has_all([TMCItem.CANE_OF_PACCI, TMCItem.TINGLE_TROPHY]),
                ]),
            #endregion
            ...
            TMCLocation.CASTLE_DOJO_NPC:
                self.has_all([TMCItem.LANTERN, TMCItem.PROGRESSIVE_SWORD]),
            ...
            TMCLocation.LON_LON_DIG_SPOT:
                self.logic_and([
                    self.access_lonlon_right(),
                    self.has_any([TMCItem.CANE_OF_PACCI, TMCItem.ROCS_CAPE]),
                    self.has(TMCItem.MOLE_MITTS),
                ]),
            ...
            TMCLocation.FALLS_LOWER_WATERFALL_FUSION_DOJO_NPC: # Fusion 1D
                self.has_all([TMCItem.FLIPPERS, TMCItem.PROGRESSIVE_SWORD]),
            ...
            TMCLocation.FALLS_ENTRANCE_HP:
                self.has_all([TMCItem.FLIPPERS, TMCItem.BOMB_BAG]),
            TMCLocation.FALLS_WATER_DIG_CAVE_FUSION_HP: # Fusion 1F
                self.has_all([TMCItem.FLIPPERS, TMCItem.BOMB_BAG, TMCItem.MOLE_MITTS]),
            ...
            TMCLocation.FALLS_NORTH_DIG_SPOT:
                self.has_all([TMCItem.GRIP_RING, TMCItem.MOLE_MITTS]),
            TMCLocation.FALLS_ROCK_FUSION_CHEST: # Fusion 61
                self.has(TMCItem.GRIP_RING),
            TMCLocation.FALLS_WATERFALL_FUSION_HP:
                self.has_all([TMCItem.GRIP_RING, TMCItem.FLIPPERS]),
            ...
            TMCLocation.MINISH_WOODS_FLIPPER_HOLE_MIDDLE_CHEST:
                self.has_all([TMCItem.BOMB_BAG, TMCItem.FLIPPERS]),
            ...
            TMCLocation.CRENEL_BASE_WATER_CAVE_LEFT_CHEST:
                self.has(TMCItem.BOMB_BAG), # can alternatively require cape if the bomb wall is broken
            TMCLocation.CRENEL_BASE_WATER_CAVE_RIGHT_CHEST:
                self.has(TMCItem.BOMB_BAG), # can alternatively require cape if the bomb wall is broken
            TMCLocation.CRENEL_BASE_WATER_CAVE_HP:
                self.has(TMCItem.BOMB_BAG), # can alternatively require cape/flippers if the bomb wall is broken
            TMCLocation.CRENEL_BASE_MINISH_VINE_HOLE_CHEST:
                self.logic_and([
                    self.has_any([TMCItem.BOMB_BAG, TMCItem.ROCS_CAPE]),
                    self.has_any([TMCItem.BOMB_BAG, TMCItem.GUST_JAR]),
                ]),
            ...
            TMCLocation.WESTERN_WOODS_TOP_DIG1:
                self.has(TMCItem.MOLE_MITTS), # fusion 48
            ...
            TMCLocation.WESTERN_WOODS_BOTTOM_DIG1:
                self.has(TMCItem.MOLE_MITTS), # fusion 4C
            ...
            TMCLocation.SWAMP_CENTER_CHEST:
                self.has(TMCItem.PROGRESSIVE_BOW),
            ...
            TMCLocation.SWAMP_WATERFALL_FUSION_DOJO_NPC: # Fusion 0C
                self.has_all([TMCItem.PROGRESSIVE_BOW, TMCItem.FLIPPERS]),
            ...
            TMCLocation.SWAMP_SOUTH_CAVE_CHEST:
                self.logic_or([
                    self.has_any([TMCItem.ROCS_CAPE, TMCItem.FLIPPERS]),
                    self.has_all([TMCItem.PEGASUS_BOOTS, TMCItem.PROGRESSIVE_BOW]),
                ]),
            TMCLocation.SWAMP_DOJO_HP:
                self.logic_or([
                    self.has_any([TMCItem.ROCS_CAPE, TMCItem.PROGRESSIVE_BOW]),
                    self.has_all([TMCItem.PEGASUS_BOOTS, TMCItem.FLIPPERS]),
                ]),
            ...
            TMCLocation.SWAMP_MINISH_FUSION_NORTH_CRACK_CHEST: # Fusion 4B
                self.has_any([TMCItem.PEGASUS_BOOTS, TMCItem.ROCS_CAPE, TMCItem.PROGRESSIVE_BOW]),
            ...
            TMCLocation.TOWN_INN_BACKDOOR_HP:
                self.has_any([TMCItem.ROCS_CAPE, TMCItem.FLIPPERS, TMCItem.CANE_OF_PACCI]),
            ...
            TMCLocation.TOWN_DOJO_NPC_3:
                self.has_all([TMCItem.PROGRESSIVE_SWORD, TMCItem.PEGASUS_BOOTS]),
            TMCLocation.TOWN_DOJO_NPC_4:
                self.has_all([TMCItem.PROGRESSIVE_SWORD, TMCItem.ROCS_CAPE]),
            ...
            TMCLocation.TOWN_UNDER_LIBRARY_FROZEN_CHEST:
                self.has_all([TMCItem.FLIPPERS, TMCItem.LANTERN, TMCItem.OCARINA, TMCItem.CANE_OF_PACCI]),
            TMCLocation.TOWN_UNDER_LIBRARY_BIG_CHEST:
                self.logic_and([
                    ...
                    self.logic_or([
                        ...
                        self.has_all([TMCItem.FLIPPERS, TMCItem.OCARINA, TMCItem.CANE_OF_PACCI]),
                    ]),
                ]),
            ...
            TMCLocation.FORTRESS_LEFT_3F_SWITCH_CHEST:
                self.has_all([TMCItem.MOLE_MITTS,TMCItem.PROGRESSIVE_BOW]),
            ...
            TMCLocation.FORTRESS_BACK_LEFT_BIG_CHEST:
                self.logic_and([
                    ...
                    self.has(TMCItem.SMALL_KEY_FOW,2)
                ]),
    ...
    def can_pass_trees(self) -> CollectionRule:
        return self.logic_or([
            self.has_any([TMCItem.PROGRESSIVE_SWORD, TMCItem.BOMB_BAG, TMCItem.LANTERN]),
            self.has(TMCItem.PROGRESSIVE_BOW, 2)
        ])
    ...
    def access_lonlon_right(self) -> CollectionRule:
        ...
        return self.logic_or([
            self.has_any([TMCItem.LONLON_KEY, TMCItem.ROCS_CAPE]),
